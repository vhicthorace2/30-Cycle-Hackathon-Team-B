...
const MetricCard = ({ title, value, icon: Icon, trend }: MetricCardProps) => (
  <motion.div
    ...
    className="flex flex-col items-center text-center gap-4 p-7 bg-white border-2 border-black rounded-[2.5rem] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all relative overflow-hidden group cursor-default"
  >
    ...
    <div className="relative z-10">
      <div className="flex items-center justify-center gap-2">
        <h4 className="text-3xl font-black tracking-tighter text-black leading-none font-[family-name:var(--font-bricolage)]">{value}</h4>
        {trend && (
      ...
      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-400 mt-2.5 leading-none">{title}</p>
    </div>
  </motion.div>
);
