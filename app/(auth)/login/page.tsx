  ...
  return (
    <div className="h-screen w-full flex bg-white font-sans overflow-hidden relative">
      ...
      <div className="w-full lg:w-[33.3%] h-full flex items-center justify-center p-4 md:p-6 relative overflow-hidden bg-white">
        ...
        >
          <div className={`absolute top-0 left-0 right-0 h-1.5 transition-colors duration-500 ${isAdminLogin ? 'bg-red-500' : 'bg-gradient-to-r from-[#F472B6] via-[#60A5FA] to-[#FDE047]'}`} />
          ...
          <div className="relative z-10 px-6 pt-12 pb-8 md:px-8 md:pt-10 md:pb-8 flex flex-col items-center">
            ...
            <div className="w-full mb-6 md:mb-5">
               ...
               >
                 {isAdminLogin ? 'Switch to Creator Login' : 'Switch to Admin Login'}
               </button>
            </div>
            ...
            <form
              ...
              onSubmit={async (e) => {
                ...
                setLoading(true);
                try {
                  const endpoint = isAdminLogin ? API_ENDPOINTS.auth.adminLogin : API_ENDPOINTS.auth.login;
              ...
              <div className="flex flex-col gap-3 md:gap-2.5">
                 ...
                 {!isAdminLogin && (
                   <>
                     ...
                     <button type="button" onClick={handleGoogleLogin} className="w-full py-3.5 md:py-3 rounded-full border-1 border-black bg-white text-black text-sm md:text-xs font-bold flex items-center justify-center gap-2.5 transition-all hover:bg-zinc-50 active:scale-[0.98]">
