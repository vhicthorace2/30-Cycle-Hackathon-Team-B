...
export type WorkerQueueName =
  | typeof YOUTUBE_SYNC_BATCH_QUEUE
  | typeof YOUTUBE_SYNC_QUEUE
  | typeof ML_INFERENCING_QUEUE;

export type WorkerJobName =
  | typeof YOUTUBE_SYNC_BATCH_JOB
  | typeof YOUTUBE_SYNC_JOB
  | typeof ML_INFERENCING_JOB;
